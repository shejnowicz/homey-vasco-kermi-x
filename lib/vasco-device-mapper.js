...
function toDeviceState(raw) {
  ...
  return {
    ...
    // X500 Controller reports effective level 13 (observed 2026-09-11),
    // while Homey and the command builder use canonical Controller mode 5.
    mode: raw.level === 13 ? 5 : optionalValue(raw.level),
