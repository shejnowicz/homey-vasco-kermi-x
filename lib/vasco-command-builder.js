...
const FIREPLACE_COMMAND = Symbol('fireplaceCommand');
...
function buildFireplaceCommand(raw, { minutes }) {
  ...
  delete command.nextParameter;
  delete command.nextValue;
  Object.defineProperty(command, FIREPLACE_COMMAND, { value: true });
  return command;
}

function isFireplaceCommand(command) {
  return command?.[FIREPLACE_COMMAND] === true
